...
def save_model_checkpoint_hf(
    ...
    if rank == 0:
        ...
        tokenizer.save_pretrained(save_full_path)
        print(f"model checkpoint & tokenizer saved for epoch {epoch} at {save_full_path}\n")
